...
#define PARAM_ROUTE_OSC_MASK    0x06
#define PARAM_ROUTE_PARAM_MASK  0x07
#define PARAM_ROUTE_GLOBAL_MASK 0x08
#define PARAM_ROUTE_SAVE        0x09
#define PARAM_ROUTE_CLEAR       0x0A
#define PARAM_ROUTE_CLEAR_ALL   0x0B
#define PARAM_ROUTE_CONFIRM     0x0C
...
// Route destination targets - No longer needed after V11 update
